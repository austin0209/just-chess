...
cc -o main obj/main.o obj/board.o obj/pieces.o obj/linked_list.o -s -Wall -std=c99 -I/opt/raylib/src -L/opt/raylib/release/libs/linux -lraylib -lGL -lm -lpthread -ldl -lrt -lX11
./main
